...
namespace Pamir {
    [ExecuteAlways]
    public class RecordedRewindableObject : MonoBehaviour
    {
        ...
        [SerializeField] private List<Vector3> rewindPositions;
        [SerializeField] private List<Quaternion> rewindRotations;
